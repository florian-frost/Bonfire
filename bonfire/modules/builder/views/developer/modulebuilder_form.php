...
<div class='module-builder'>
    ...
    <div class="admin-box">
        ...
        echo form_open($formSubmitUrl, array('id' => 'module_form', 'class' => 'form'));
            //------------------------------------------------------------------
            // Module Details
            //------------------------------------------------------------------
        ?>
            <fieldset id="module_details">
                ...
                <div class="form-group<?php echo form_error('module_name') ? ' error' : ''; ?>">
                    <label for="module_name" class="control-label block"><?php echo lang('mb_form_mod_name'); ?></label>
                    <div class="controls">
                        <input name="module_name" class="form-control" id="module_name" type="text" value="<?php echo set_value("module_name"); ?>" placeholder="<?php echo lang('mb_form_mod_name_ph'); ?>" />
                ...
                <div class="form-group mb_advanced<?php echo form_error('module_description') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="module_description" class="form-control" id="module_description" type="text" value="<?php echo set_value("module_description", lang('mb_form_mod_desc_ph')); ?>" placeholder="<?php echo lang('mb_form_mod_desc_ph'); ?>" />
                ...
                <div class="form-group mb_advanced">
                    ...
                    <div class="checkbox" aria-labelledby="contexts_label" role="group">
                ...
                <div class="form-group mb_advanced<?php echo form_error('form_action') ? ' error' : ''; ?>">
                    ...
                    <div class="checkbox" aria-labelledby="form_action_label" role="group">
                        <?php
                ...
                <div class="form-group">
                    ...
                    <div class="radio" id='mb_module_db'>
            ...
            <fieldset id="db_details">
                ...
                <div class="form-group mb_advanced<?php echo form_error('table_name') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="table_name" class="form-control" id="table_name" type="text" value="<?php echo set_value('table_name'); ?>" placeholder="<?php echo lang('mb_form_table_name_ph'); ?>" />
                ...
                <div class="form-group mb_advanced<?php echo form_error('form_error_delimiters') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="form_error_delimiters" class="form-control" id="form_error_delimiters" type="text" value="<?php echo set_value("form_error_delimiters", "<span class='error'>,</span>"); ?>" />
                ...
                <div class="form-group mb_advanced">
                    ...
                    <div class="controls">
                        <select name="textarea_editor" class="form-control" id="textarea_editor">
                ...
                <div class="form-group mb_advanced<?php echo form_error('soft_delete_field') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="soft_delete_field" class="form-control" id="soft_delete_field" type="text" value="<?php echo set_value('soft_delete_field', lang('mb_soft_delete_field_ph')); ?>" />
                ...
                <div class="form-group mb_advanced<?php echo form_error('deleted_by_field') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="deleted_by_field" class="form-control" id="deleted_by_field" type="text" value="<?php echo set_value('deleted_by_field', lang('mb_deleted_by_field_ph')); ?>" />
                        <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                ...
                <div class="form-group mb_advanced<?php echo form_error('created_field') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="created_field" class="form-control" id="created_field" type="text" value="<?php echo set_value('created_field', lang('mb_form_created_field_ph')); ?>" />
                        <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                ...
                <div class="form-group mb_advanced<?php echo form_error('created_by_field') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="created_by_field" class="form-control" id="created_by_field" type="text" value="<?php echo set_value('created_by_field', lang('mb_form_created_by_field_ph')); ?>" />
                        <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                ...
                <div class="form-group mb_advanced<?php echo form_error('modified_field') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="modified_field" class="form-control" id="modified_field" type="text" value="<?php echo set_value('modified_field', lang('mb_form_modified_field_ph')); ?>" />
                        <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                ...
                <div class="form-group mb_advanced<?php echo form_error('modified_by_field') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="modified_by_field" class="form-control" id="modified_by_field" type="text" value="<?php echo set_value('modified_by_field', lang('mb_form_modified_by_field_ph')); ?>" />
                        <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                ...
                <div class="form-group mb_new_table<?php echo form_error('primary_key_field') ? ' error' : ''; ?>">
                    <label for="primary_key_field" class="control-label block"><?php echo lang('mb_form_primarykey'); ?></label>
                    <div class="controls">
                        <input name="primary_key_field" class="form-control" id="primary_key_field" type="text" value="<?php echo set_value("primary_key_field", (isset($existing_table_fields[0]) && $existing_table_fields[0]['primary_key']) ? $existing_table_fields[0]['name'] : 'id'); ?>" />
            ...
            <div id="all_fields">
                ...
                <fieldset id="field<?php echo $count; ?>_details">
                    ...
                    <?php endif; ?>
                    <div class="form-group<?php echo form_error($viewFieldLabel) ? ' error' : ''; ?>">
                        <label class="control-label" for="<?php echo $viewFieldLabel; ?>"><?php echo lang('mb_form_label'); ?></label>
                        <div class="controls">
                            <input name="<?php echo $viewFieldLabel; ?>" class="form-control" id="<?php echo $viewFieldLabel; ?>" type="text" value="<?php echo set_value($viewFieldLabel, isset($existing_table_fields[$count]) ? ucwords(str_replace('_', ' ', $existing_table_fields[$count]['name'])) : ''); ?>" placeholder="<?php echo lang('mb_form_label_ph'); ?>" />
                            <span class="help-inline"><?php echo form_error($viewFieldLabel); ?></span>
                        </div>
                    </div>
                    <div class="form-group<?php echo form_error($viewFieldName) ? ' error' : ''; ?>">
                        <label class="control-label" for="<?php echo $viewFieldName; ?>"><?php echo lang('mb_form_fieldname'); ?></label>
                        <div class="controls">
                            <input name="<?php echo $viewFieldName; ?>" class="form-control" id="<?php echo $viewFieldName; ?>" type="text" value="<?php echo set_value($viewFieldName, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['name'] : ''); ?>" maxlength="30" placeholder="<?php echo lang('mb_form_fieldname_ph'); ?>" />
                    ...
                    echo form_dropdown($viewFieldType, $view_field_types, set_value($viewFieldType, $default_field_type), lang('mb_form_type'), 'class="form-control"', '<span class="help-inline">' . form_error($viewFieldType) . '</span>');
                    echo form_dropdown($dbFieldType, $db_field_types, set_value($dbFieldType, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['type'] : ''), lang('mb_form_dbtype'), 'class="form-control"', '<span class="help-inline">' . form_error($dbFieldType) . '</span>');
                    ...
                    <div class="form-group <?php echo form_error($dbFieldLength) ? 'error' : ''; ?>">
                        ...
                        <div class="controls">
                            <input name="<?php echo $dbFieldLength; ?>" class="form-control" id="<?php echo $dbFieldLength; ?>" type="text" value="<?php echo set_value($dbFieldLength, $default_max_len); ?>" placeholder="<?php echo lang('mb_form_length_ph'); ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox" aria-labelledby="<?php echo $validationLbl; ?>" role="group">
                            <?php
                    ...
                    <div class="form-group mb_advanced">
                        ...
                        <div class="radio" aria-labelledby="<?php echo $validLimitLbl; ?>" role="group">
                            <?php
