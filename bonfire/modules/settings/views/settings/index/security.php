<fieldset>
    ...
    <div class="form-group<?php echo form_error('allow_register') ? $errorClass : ''; ?>">
        <div class="checkbox">
            <label class='checkbox' for="allow_register">
                <input type="checkbox" name="allow_register" class="checkbox" id="allow_register" value="1" <?php echo set_checkbox('auth.allow_register', 1, isset($settings['auth.allow_register']) && $settings['auth.allow_register'] == 1); ?> />
    ...
    <div class="form-group">
        ...
        <div class="radio" aria-labelledby="use_usernames_label" role="group">
            <label class="" for="use_username">
                <input type="radio" id="use_username" class="radio" name="use_usernames" value="1" <?php echo set_radio('auth.use_usernames', 1, isset($settings['auth.use_usernames']) && $settings['auth.use_usernames'] == 1); ?> />
                <?php echo lang('bf_username'); ?>
            </label>
            <label class="" for="use_email">
                <input type="radio" id="use_email" class="radio" name="use_usernames" value="0" <?php echo set_radio('auth.use_usernames', 0, isset($settings['auth.use_usernames']) && $settings['auth.use_usernames'] == 0); ?> />
    ...
    <div class="form-group">
        ...
        <div class="checkbox" aria-labelledby='allow_name_change_label' role='group'>
            <label class="" for="allow_name_change">
                <input type="checkbox" name="allow_name_change" id="allow_name_change" class="checkbox" <?php echo set_checkbox('auth.allow_remember', 1, isset($settings['auth.allow_name_change']) && $settings['auth.allow_name_change'] == 1); ?> />
    ...
    <div class="form-group">
        <div class="checkbox">
            <label class="" for="allow_remember">
    ...
    <div class="form-group">
        ...
        <div class="checkbox" aria-labelledby='password_options_label' role='group'>
            <label class="" for="password_force_numbers">
                <input type="checkbox" name="password_force_numbers" id="password_force_numbers" class="checkbox" value="1" <?php echo set_checkbox('password_force_numbers', 1, isset($settings['auth.password_force_numbers']) && $settings['auth.password_force_numbers'] == 1); ?> />
                <?php echo lang('bf_password_force_numbers'); ?>
            </label>
            <label class="" for="password_force_symbols">
                <input type="checkbox" name="password_force_symbols" id="password_force_symbols" class="checkbox" value="1" <?php echo set_checkbox('password_force_symbols', 1, isset($settings['auth.password_force_symbols']) && $settings['auth.password_force_symbols'] == 1); ?> />
                <?php echo lang('bf_password_force_symbols'); ?>
            </label>
            <label class="" for="password_force_mixed_case">
                <input type="checkbox" name="password_force_mixed_case" id="password_force_mixed_case" class="checkbox" value="1" <?php echo set_checkbox('password_force_mixed_case', 1, isset($settings['auth.password_force_mixed_case']) && $settings['auth.password_force_mixed_case'] == 1); ?> />
                <?php echo lang('bf_password_force_mixed_case'); ?>
            </label>
            <label class="" for="password_show_labels">
                <input type="checkbox" name="password_show_labels" id="password_show_labels" class="checkbox" value="1" <?php echo set_checkbox('password_show_labels', 1, isset($settings['auth.password_show_labels']) && $settings['auth.password_show_labels'] == 1); ?> />
