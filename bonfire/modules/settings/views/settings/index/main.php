<fieldset>
    ...
    <div class="form-group<?php echo form_error('offline_reason') ? $errorClass : ''; ?>"<?php echo isset($settings['site.status']) && $settings['site.status'] == 1 ? ' style="display:none"' : ''; ?>>
        ...
        <div class="controls">
            <textarea id="offline_reason" name="offline_reason" class="form-control" cols="60" rows="5"><?php echo isset($settings['site.offline_reason']) ? $settings['site.offline_reason'] : ''; ?></textarea>
    ...
    <div class="form-group<?php echo form_error('list_limit') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="list_limit" id="list_limit" class="form-control" value="<?php echo set_value('list_limit', isset($settings['site.list_limit']) ? $settings['site.list_limit'] : ''); ?>" class="col-lg-1" />
    ...
    <div class="form-group<?php echo form_error('languages') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <select name="languages[]" id="languages" class="form-control" multiple="multiple">
                <?php
